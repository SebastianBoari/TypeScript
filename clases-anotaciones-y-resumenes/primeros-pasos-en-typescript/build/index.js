...
// En listas
let listaCompraLunes = ["Pan", "Manteca", "Leche"];
let listaCompraMartes = [...listaCompraLunes, "Huevos", "Carne"];
let listaCompraMiercoles = ["Pescado", "Vino"];
...
let taskList = ["Tarea 1", "Tarea 2"];
let randomTypes = ["Hola", true, 256];
...
(function (Estados) {
    ...
    Estados["Pendiente"] = "P"; // Valor asignado: "P"
})(Estados || (Estados = {}));
;
...
var PuestoDeCarrera;
(function (PuestoDeCarrera) {
    PuestoDeCarrera[PuestoDeCarrera["Primero"] = 1] = "Primero";
    PuestoDeCarrera[PuestoDeCarrera["Segundo"] = 2] = "Segundo";
    PuestoDeCarrera[PuestoDeCarrera["Tercero"] = 3] = "Tercero"; // Valor asignado: 3 (autoincremental)
})(PuestoDeCarrera || (PuestoDeCarrera = {}));
;
let puestoMaraton = PuestoDeCarrera.Tercero;
...
let puestoF1 = PuestoDeCarrera.Primero;
;
...
function ejemploReturn(apellido, nombre) {
    return `${nombre} ${apellido}`;
}
;
// Tambien podemos hacer que pueda retornar un tipo de dato u otro.
function ejemploReturn2() {
    return 3;
}
;
// |---------------------------------------------------|
// Multiple Params (Funciones con múltiples parámetros)
const lista = ["Claudia", "Sandra", "Jessica", "Luciana", "Alberto", "Rogelio", "Jorge", "Juan", "Carlos", "Roberto"];
...
*/
function ejDocs(nombre, apellido) {
    return `${nombre} ${apellido}`;
}
;
...
const mostrarEdadEmpleado = (empleado) => `${empleado.nombre} tiene ${empleado.edad} años`;
...
function ejemploAsync() {
    return __awaiter(this, void 0, void 0, function* () {
        yield "Tarea a completar antes de seguir con la secuencia de instrucciones";
...
function leerSession() {
    let nombre = sessionStorage.get("nombre");
}
;
...
const Persona_2 = require("./models/Persona");
let empleado1 = new Persona_1.Trabajador("Martin", "San Jose", 30, 2000);
let empleado2 = new Persona_1.Trabajador("Pepe", "Garcia", 31, 1000);
let empleado3 = new Persona_1.Trabajador("Juan", "Perez", 34, 3000);
empleado1.saludar();
let jefe = new Persona_2.Jefe("Pablo", "Garcia", 50);
...
const miPrimerSingleton = Singleton_1.Singleton.getInstance();
const miSegundoSingleton = Singleton_1.Singleton.getInstance();
